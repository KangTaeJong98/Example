...
object MovieMemoryData {
    val movieList = mutableListOf(
            ...
            Movie(6L, "https://upload.wikimedia.org/wikipedia/ko/thumb/3/35/%EC%9D%91%EB%8B%B5%ED%95%98%EB%9D%BC_1988.jpg/375px-%EC%9D%91%EB%8B%B5%ED%95%98%EB%9D%BC_1988.jpg", "응답하라 1988", "《응답하라 1988》은 2015년 11월 6일부터 2016년 1월 16일까지 tvN에서 방영된 드라마이며, 2013년에 방영된 《응답하라 1994》의 후속작으로 응답하라 시리즈의 세 번째 작품이다.당초 2016년 1월 9일에 종영할 예정이었지만, 작품의 완성도를 더 높이기 위해 1월 1일과 2일에 결방하여 최종회가 1주일 순연되었다.[1]\n" +
                    "\n" +
